...
2. WHEN a matching `review_reward` promo code exists, THE Promo_Code_System SHALL send the promo code details to the reader via the existing reader notifications system.
